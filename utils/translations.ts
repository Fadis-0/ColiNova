...
export const translations = {
  ar: {
    ...
    specialInstructions: "تعليمات خاصة",
        ...
        wallet: 'المحفظة',
        walletSubtitle: 'رصيدك وطرق الدفع',
        currentBalance: 'الرصيد الحالي',
        points: 'نقاط',
        refillWallet: 'شحن المحفظة',
        debitCard: 'بطاقة بنكية',
        ccp: 'CCP',
        baridiMob: 'بريدي موب',
        withdrawPoints: 'سحب النقاط',
        withdrawSubtitle: 'حول نقاطك إلى أموال حقيقية',
        withdraw: 'سحب',
        earningsHistory: 'سجل الأرباح',
        earningsHistorySubtitle: 'عرض الطرود المكتملة والأرباح',
        paymentSuccess: 'تم الدفع بنجاح!',
        ccpPayment: 'الدفع عبر CCP',
        fullName: 'الاسم الكامل',
        ccpNumber: 'رقم CCP',
        confirmPayment: 'تأكيد الدفع',
        baridiMobPayment: 'الدفع عبر بريدي موب',
        phoneNumber: 'رقم الهاتف',
        debitCardPayment: 'الدفع عبر البطاقة البنكية',
    ...
    acceptedParcels: 'Accepted Parcels',
        ...
        wallet: 'Wallet',
        walletSubtitle: 'Your balance and payment methods',
        ...
        withdrawSubtitle: 'Turn your points into real money',
        withdraw: 'Withdraw',
        earningsHistory: 'Earnings History',
        earningsHistorySubtitle: 'View your completed parcels and earnings',
        paymentSuccess: 'Payment successful!',
        ccpPayment: 'CCP Payment',
        fullName: 'Full Name',
        ccpNumber: 'CCP Number',
        confirmPayment: 'Confirm Payment',
        baridiMobPayment: 'BaridiMob Payment',
        ...
        personalReception: 'Personal Reception',
        depositWarehouse: 'Deposit Warehouse',
        selectDepositLocation: 'Select Deposit Location',
        depositLocation1: 'Deposit Location 1',
        depositLocation2: 'Deposit Location 2',
        depositLocation3: 'Deposit Location 3',
    ...
    acceptedParcels: 'Livraisons Acceptées',
        ...
        historySubtitle: 'Consultez lhistorique de vos livraisons de colis',
        wallet: 'Portefeuille',
        walletSubtitle: 'Votre solde et vos moyens de paiement',
        ...
        ccp: 'CCP',
        baridiMob: 'Baridi Mob',
        withdrawPoints: 'Retirer des points',
        withdrawSubtitle: 'Transformez vos points en argent réel',
        withdraw: 'Retirer',
        earningsHistory: 'Historique des gains',
        earningsHistorySubtitle: 'Consultez vos colis terminés et vos gains',
        paymentSuccess: 'Paiement réussi !',
        ccpPayment: 'Paiement CCP',
        fullName: 'Nom complet',
        ccpNumber: 'Numéro CCP',
        confirmPayment: 'Confirmer le paiement',
        baridiMobPayment: 'Paiement BaridiMob',
        phoneNumber: 'Numéro de téléphone',
        debitCardPayment: 'Paiement par carte de débit',
        ...
        personalReception: 'Réception personnelle',
        depositWarehouse: 'Entrepôt de dépôt',
        selectDepositLocation: 'Sélectionnez le lieu de dépôt',
        depositLocation1: 'Lieu de dépôt 1',
        depositLocation2: 'Lieu de dépôt 2',
        depositLocation3: 'Lieu de dépôt 3',
