...
import { ArrowRight, ArrowLeft, Search, Truck } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-80px)] bg-gray-50 p-8" dir={dir}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900">{t('welcomeLoginTitle')}, {user?.name.split(' ')[0]}!</h1>
          <p className="text-lg text-gray-600 mt-2">{t('transporterDashboardSubtitle')}</p>
        </div>
